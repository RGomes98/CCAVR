...
const filesSchema = z.array(z.instanceof(File)).superRefine((files, refinementContext) => {
...
type CreateNews = z.infer<typeof createNewsSchema>;

export { filesSchema, createNewsSchema };
export type { Files, CreateNews };
