  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.text}>
        Essa área de depoimentos é o espaço onde nossos beneficiados, seus familiares, colaboradores
        e parceiros podem compartilhar suas experiências e histórias com a Casa da Criança e do
