...
function generateEmailTemplate({ name, email, phone, city, subject, content }: GenerateEmailTemplate) {
                              ...
                              >
                                <p style="margin: 0">
                                  <strong style="font-size: 14px; color: #999; line-height: 18px"
                                    >Telefone:</strong
                                  ><br />
                                  (${phone.charAt(0).concat(phone.charAt(1))}) 
